      ...
      <v-row class="no-gutters">
        ...
        <v-col class="col-12 px-4 text--bold" style="font-weight: 900;">
          ...
          <h5 class="d-flex">
            ...
            {{ "Prime Location - 4KM to the beach" }}
          </h5>
          ...
          <h5 class="d-flex">
            ...
            {{ "1KM to the highway - 4 Min drive" }}
          </h5>
          ...
          <h5 class="d-flex">
            ...
            {{ "Close to 5-star hotels, schools, and amenities" }}
          </h5>
        </v-col>
        <v-col class="col-12 d-flex px-4">
          ...
          <v-col class="col-5 offset-1">
            <span
              class="d-flex mr-2 pointer cta tex-center d-flex justify-center align-center red rounded white--text"
              @click="go('property/diani-sunrise-estate-phase-two')"
            >
              <span class="body-text px-3">
                {{ "View" }}
              </span>
...
export default {
  ...
  methods: {
    changeSource (code, counterAlreadySet) {
      const lastCharacter = code.slice(-1)
      if (!counterAlreadySet) {
        this.counter = Number(lastCharacter)
      }
    ...
    nextPhoto () {
      ...
      const imageName = 'sunrise_' + this.counter
      this.changeSource(imageName, true)
    },
    previousPhoto () {
      console.log(this.counter)
      if (this.counter === 0) {
